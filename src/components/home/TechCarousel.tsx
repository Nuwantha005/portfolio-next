...
const TechCarousel = () => {
  ...
  const imageArray = [
    ...
    { src: "./Images/svgIcons/simple-icons--scipy.svg", alt: "SciPy" },
    { src: "./Images/svgIcons/devicon--opencv.svg", alt: "OpenCV" },
    // Visualization & GUI
    { src: "./Images/svgIcons/devicon--qt.svg", alt: "Qt" },
    { src: "./Images/svgIcons/simple-icons--vtk.svg", alt: "VTK" },
    { src: "./Images/svgIcons/devicon--matplotlib.svg", alt: "Matplotlib" },
    { src: "./Images/svgIcons/skill-icons--p5js.svg", alt: "p5.js" },
    // Tools
    { src: "./Images/svgIcons/logos--jupyter.svg", alt: "Jupyter" },
    { src: "./Images/svgIcons/devicon--latex.svg", alt: "LaTeX" },
  ...
  return (
    <main className="relative min-h-24 sm:min-h-32 flex flex-col justify-center align-middle rounded-3xl bg-slate-200/80 dark:bg-slate-900/80 overflow-hidden">
            ...
            >
              {imageArray.map((item, index) => (
                <li key={index} className="flex flex-col items-center">
                  ...
                  />
                  <span className="mt-1 sm:mt-2 text-slate-800 dark:text-white text-xs sm:text-sm">
                    {item.alt}
                  </span>
                </li>
              ))}
