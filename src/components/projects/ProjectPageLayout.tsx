  ...
  return (
    <div>
      ...
      <div className="relative flex h-screen w-screen flex-col items-center justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl">
        ...
        {/* 3-column layout: TOC | main (scrollable) | sidebar (synced scroll) */}
        <div className="relative z-10 w-full h-full max-w-[1920px] mx-auto flex gap-3 overflow-hidden">
          ...
          {/* Synced scroll: scrollTop mapped proportionally to main scroll */}
          <aside
            ref={rightSidebarRef}
            className="hidden 2xl:block w-64 flex-shrink-0 pr-3 pt-3 pb-3 overflow-y-auto overflow-x-hidden scrollbar-none"
          >
