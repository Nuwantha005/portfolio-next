      ...
      <FloatingSection>
        <div className="flex flex-col items-center relative">
          ...
          <div className="absolute top-2 right-2 z-10 flex flex-col gap-1">
            {featured && (
              <span className="bg-gradient-to-r from-yellow-500 to-amber-500 text-white text-xs px-2 py-1 rounded-full flex items-center gap-1 shadow-md">
          ...
          {year && (
            <div className="absolute top-2 left-2 z-10">
              <span className="bg-gray-800/80 dark:bg-gray-200/80 text-white dark:text-gray-800 text-xs px-2 py-1 rounded-full">
                {year}
              </span>
            </div>
          )}
