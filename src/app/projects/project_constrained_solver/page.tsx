...
function Project_ConstrainedSolver() {
  return (
    <ProjectPageLayout
      title="Constrained Parametric Curve Solver"
      fetchUrl="/projects/project_constrained_solver/files.json"
      projectSlug="projects/project_constrained_solver"
    >
      {(items, getItem, handleOpen) => (
        <>
          ...
          <FloatingSection>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-6">
              <div className="lg:w-1/2 text-justify">
                <p className="mb-4">
                  In CAD-based turbomachinery design, blade profiles are defined
                  by <strong>parametric curves</strong> (Bézier and B-Spline)
                  whose control points the designer drags interactively.
                  Geometric constraints — tangency to circles, lines, or other
                  curves — must be maintained in <strong>real time</strong> as
                  the user edits the shape, giving immediate visual feedback
                  without manual re-solving.
                </p>
                <p className="mb-4">
                  This project developed a{" "}
                  <strong>dual-solver algorithm</strong> that combines a novel
                  linear matrix formulation with a nonlinear fallback optimizer.
                  The linear solver uses minimum-norm control-point displacement
                  to guarantee smooth transitions, while the nonlinear solver
                  (SLSQP) handles over-constrained or degenerate cases that
                  produce singular matrices.
                </p>
                <p>
                  ...
                  production C++ implementation was integrated into a commercial
                  turbomachinery design tool.
                </p>
              </div>
          ...
          <FloatingSection>
            ...
            <div className="text-justify space-y-3">
              <p>
                ...
                shape airfoil cross-sections using control points. These curves
                must satisfy geometric constraints — for example, a leading-edge
                curve must be tangent to both the pressure-side and suction-side
                curves as well as the stream-surface boundary. Moving any
                control point should <strong>automatically reposition</strong>{" "}
                the remaining points so that all constraints stay satisfied.
              </p>
              <p>
                ...
                <strong>(2)</strong> a generic blade section editor where Bézier
                curves must be tangent to boundary lines and adjacent curves at
                their endpoints.
              </p>
            </div>
          </FloatingSection>
          ...
          >
            <p className="mb-4">
              The first approach modeled the tangency constraints as a system of
              nonlinear equations. For a curve tangent to a circle, two
            ...
            <p>
              ...
              validated the concept for Bézier curves tangent to three circles.
              The approach was then generalized from 4 to arbitrary numbers of
              control points, and extended to B-Splines.
            </p>
          </AutoAdjustingSection>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  control points — essential for higher-degree curves that need
          ...
          <FloatingSection>
            ...
            <div className="text-justify space-y-3">
              <p>
                ...
                solver would sometimes <strong>diverge</strong> or take too long
                for real-time feedback, and it offered no guarantee of{" "}
                <strong>minimal displacement</strong> — meaning the curve could
                change shape drastically even when a subtle adjustment would
                suffice.
              </p>
              <p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-2 sm:gap-3 items-stretch">
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  The generic blade section editor required curves to be tangent
                  to boundary lines and adjacent curves. This motivated a
                  reformulation: instead of solving for absolute control-point
                  positions, the algorithm solves for{" "}
                  <strong>control-point displacements</strong> — the minimal
                  movement needed to satisfy all constraints from the current
                  configuration.
                </p>
                <p>
                  Expressing the problem in terms of displacements transforms it
                  into a linear system, solvable via a{" "}
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                ...
                <p>
                  ...
                  line through the first control point in the tangent direction.
                  This introduces a scalar parameter instead of a 2D point,
                  reducing the unknowns while maintaining the constraint
                ...
                <p>
                  ...
                  When the curve doesn&apos;t yet intersect the target geometry,
                  the algorithm samples candidate displacements and selects the
                  one with minimum magnitude — then iterates until the
                  constraint is met within tolerance. This bootstrapping step
                  feeds the linear solver with the displacement vector it
                  requires.
                </p>
              </div>
            </FloatingSection>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  displacement from each sample to the nearest curve point, and
                  picks the minimum-displacement pair as the constraint input
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  displaces that point back. This ensures convergence from both
                  initial conditions — whether the curve starts inside or
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-2 sm:gap-3 items-stretch">
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  The linear minimum-norm solver handles most interactive cases
                  efficiently, but two situations require falling back to the
                  nonlinear solver:
                </p>
                <ul className="list-disc list-inside space-y-1 ml-2">
                  <li>
                    <strong>Over-constrained systems:</strong> With only 4
                    control points and multiple tangency constraints, the linear
                    coefficient matrix becomes singular. The nonlinear SLSQP
                    optimizer can still find approximate solutions by treating
                    the constraints as optimization targets.
                  </li>
                  <li>
                    <strong>Circle tangency:</strong> Point-on-circle and
                    tangent-to-circle constraints are inherently nonlinear (they
                    involve squared radius terms). These are handled via
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  optimization:{" "}
                  <strong>minimize total control-point displacement</strong> (or
                  optionally control-polygon length for simpler shapes) subject
                  to all geometric constraints as equality constraints.
                </p>
                <p>
                  ...
                  for its balance of speed and robustness on these small, dense
                  problems.
                </p>
              </div>
            </FloatingSection>
          ...
          <FloatingSection>
            ...
            <div className="text-justify space-y-3">
              ...
              <p>
                ...
                <strong>NLopt&apos;s SLSQP</strong> implementation with C-style
                callback wrappers and templated constraint/objective functions
                for type flexibility.
              </p>
              <p>
                Key computational patterns include DOF analysis before solver
                selection, adaptive gradient vector updates when the user drags
                a specific control point, and post-solve validation that
                measures constraint error to decide whether to accept the result
                or retry with the fallback solver.
              </p>
            </div>
          </FloatingSection>
          ...
          <FloatingSection>
            ...
            <div className="text-justify space-y-3">
              ...
              <p>
                The paper presents the mathematical framework in full detail; a
                separate page with the complete derivation is planned. The key
                contribution is showing that directional tangency — a constraint
                that traditionally requires nonlinear solving — can be expressed
                as a single linear row in the coefficient matrix using a 2D
                rotation matrix and cross-product identity.
              </p>
            </div>
          </FloatingSection>
