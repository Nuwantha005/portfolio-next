...
function Project_VoluteFillet() {
  return (
    <ProjectPageLayout
      title="Parametric Volute Tongue Fillet"
      fetchUrl="/projects/project_volute_fillet/files.json"
      projectSlug="projects/project_volute_fillet"
    >
        ...
        <>
          ...
          <FloatingSection>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-6">
              <div className="lg:w-1/2 text-justify">
                <p className="mb-4">
                  In centrifugal turbomachinery, the <strong>volute</strong> is
                  a spiral-shaped casing that collects high-velocity fluid
                ...
                <p className="mb-4">
                  ...
                  tangent fillet surface at this junction significantly improves
                  simulation quality and represents realistic manufacturing
                  geometry.
                </p>
                <p>
                  ...
                  with constrained filling. The algorithm was implemented in C++
                  using the OpenCascade CAD kernel and integrated into a
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-2 sm:gap-3 items-stretch">
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  The first approach involved extracting the intersection curve
                  between the scroll and exit pipe, then generating tangent
                  curves at multiple cross-sections along this intersection.
                  Each tangent curve was constructed by projecting points onto
                  both surfaces and interpolating through them.
                </p>
                <p>
                  Lofting through these tangent curves produced an approximately
                  tangent surface. However, the boundary curves varied
                  unpredictably, resulting in rough edges that didn&apos;t meet
                  quality requirements for CAD export.
                </p>
              </div>
            </FloatingSection>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  with the scroll (and vice versa), creating two smooth boundary
                  curves. A lofting operation through the lower boundary,
                  intersection wire, and upper boundary produced the fillet
                  surface.
                </p>
                <p>
          ...
          >
            ...
            <p>
              ...
              boundaries. However, it still lacked a proper corner fillet — the
              region where the fillet wraps around the end of the tongue.
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  patch takes four boundary curves and generates a smooth
                  surface that interpolates between them, with optional tangency
                ...
                <p>
                  ...
                  scroll and exit pipe surfaces) and one or two side boundaries.
                  Previous fillet sections were used as tangent surfaces for
                  subsequent ones, ensuring C2 continuity across the entire
                  fillet.
                </p>
              </div>
            </FloatingSection>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  pipe surfaces, clean boundary curves were extracted that
                  define where the fillet starts and ends on each surface.
                </p>
                <p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[3fr_1fr] gap-2 sm:gap-3 items-stretch">
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  The fillet was constructed as multiple sections, each defined
                  by boundary curves extracted from the scroll and exit pipe
                ...
                <p>
                  ...
                  with a user-defined radius that are tangent to both the scroll
                  and exit pipe section curves — replacing the earlier arbitrary
                  tangent curves with a properly parametrized construction.
                </p>
              </div>
            </FloatingSection>
          ...
          >
            <p className="mb-4">
              After building the fillet surfaces, the scroll and exit pipe faces
              were cut along the fillet boundaries to make room for the new
              geometry. This was done using surface cutting rather than Boolean
              operations — a significantly faster approach that avoids the
              tolerance issues common with Boolean operations in CAD kernels.
            </p>
            <p>
              All cut faces, unmodified volute faces, and fillet faces were then
              sewn together into a watertight shell and converted to a solid.
              Geometric analysis confirmed the correct topology: one shell, one
              solid — a valid configuration for simulation.
            </p>
          </AutoAdjustingSection>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  boundaries, it collapsed one boundary into a point — creating
                  a <strong>degenerate geometry</strong>. This was visible in
                  ISO curve grid inspections: the corner fillet showed a
                  converging pattern where the fourth boundary collapsed.
                </p>
                <p>
                  ...
                  front of the fillet rather than the corners, this had minimal
          ...
          <FloatingSection>
            ...
            <div className="text-justify space-y-3">
              ...
              <p>
                ...
                surface&apos;s natural boundaries, the original boundary curves
                were explicitly provided alongside the surface. This produced
                faces with the necessary tolerances that could be sewn together
                successfully.
              </p>
            </div>
          </FloatingSection>
          ...
          <FloatingSection>
            ...
            <div className="text-justify space-y-3">
              <p>
                The fillet builder is implemented as a single C++ class spanning
                roughly <strong>7,700 lines</strong> with over 100 methods,
                organized around a clear multi-stage pipeline. The{" "}
              ...
              <ol className="list-decimal list-inside space-y-1 ml-2">
                <li>
                  ...
                  around the tongue, identify corner vs.&nbsp;mid sections, and
                  validate topological prerequisites
                </li>
                <li>
                  <strong>Arc generation</strong> — construct guiding arcs,
                  supporting arcs, connecting arcs, and sub-arcs that define the
                  tangent curves between the scroll and exit pipe
                </li>
                <li>
                  <strong>Point assignment</strong> — distribute boundary sample
                  points across fillet sections and their individual fill
                  sub-sections
                </li>
                <li>
                  <strong>Boundary generation</strong> — build the four boundary
                  curves for each Coons-style surface patch
                </li>
                <li>
              ...
              <p>
                Each phase is self-contained with its own validation, making the
                system debuggable at any intermediate stage.
              </p>
            </div>
          </FloatingSection>
          ...
          <FloatingSection>
            ...
            <div className="text-justify space-y-3">
              <p>
                ...
                <strong>fillet sections</strong> — logical groups corresponding
                to distinct regions around the scroll–pipe intersection. Each
                fillet section contains multiple <strong>fill sections</strong>{" "}
                — individual surface patches classified into four types:{" "}
                <em>free sections</em> (interior patches with minimal
                constraints), <em>end sections</em> (at the trailing edge of the
                fillet), <em>corner sections</em> (where the scroll wraps around
                the pipe), and <em>middle sections</em> (at the front of the
                tongue). This classification drives which filling strategy is
              ...
              <p>
                ...
                intersection, storing the arc geometry, tangent edges, boundary
                points, and center location. The arc generation itself is a
                multi-pass process: guiding arcs are built first (using 2D
                tangent circle solving on the scroll surface), then supporting
                arcs, then connecting arcs that bridge between fillet sections.
              </p>
            </div>
          </FloatingSection>
          ...
          <FloatingSection>
            ...
            <div className="text-justify space-y-3">
              <p>
                <strong>UV-space interpolation over 3D projection:</strong> The
                intermediate sample points along boundaries are interpolated in
                the UV parameter space of the scroll surface rather than
                projected in 3D. This avoids the ambiguity of 3D projection onto
                a doubly-curved surface and ensures smooth parametric
                distributions even near regions of high curvature.
              </p>
              <p>
                <strong>Adaptive fill section count:</strong> The number of fill
                sections per fillet section is not fixed — it adapts based on
                the fillet radius and local geometric complexity. Smaller radii
                demand finer subdivision to prevent self-intersections, while
                larger radii can use fewer sections for efficiency.
              </p>
              <p>
              ...
              <p>
                ...
                oscillated to satisfy conflicting tangent constraints. The final
                implementation uses only positional continuity between sections,
                with tangency enforced only at the scroll and exit pipe
                boundaries where it matters for flow simulation.
              </p>
            </div>
          </FloatingSection>
          ...
          <FloatingSection>
            ...
            <div className="text-justify space-y-3">
              <p>
                ...
                volute generation system — itself a ~2,000-line class supporting
                symmetric, asymmetric, and rectangular volutes. The integration
                required carefully managing the access to the parent
                volute&apos;s topological entities (faces, edges, wires) and
                ensuring that the fillet modifications preserved the surrounding
                geometry.
              </p>
              <p>
                ...
                replaced by the trimmed versions plus the new fillet faces. This
                involved building intersection curves between the fillet
                surfaces and the existing geometry, projecting them into the
                correct parameter spaces, and performing topological operations
                (splitting wires, constructing new faces from edges) that had to
                remain consistent with the sewing tolerances.
              </p>
              <p>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  arcs used as tangent curves between the scroll and exit pipe.
                  A larger radius creates a more gradual, sweeping transition
                  while a smaller radius produces a tighter fillet closer to the
                  original sharp edge.
                </p>
              </div>
            </FloatingSection>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  replaced by the fillet. Increasing this parameter extends the
                  fillet along the tongue but reduces the effective fillet
                  radius. Together, these two parameters give designers precise
                  control over the fillet geometry.
                </p>
              </div>
            </FloatingSection>
          </div>
          ...
          <FloatingSection className="max-w-[60%] mx-auto">
            ...
            <div className="text-justify space-y-3">
              <p>
                ...
                types, and exit pipe geometries (including curved pipes). It was
                also rewritten to support exit pipes with any number of faces —
                a requirement discovered during testing with complex geometries.
              </p>
              ...
              <p>
                ...
                <strong>1–2 seconds</strong> on average, despite the complexity
                of the operations involved. After code review and presentation
                to the development team, it was merged into the main repository
                as a beta feature.
              </p>
            </div>
          </FloatingSection>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  ratio of 1.5, demonstrating the smooth transition from the
                  sharp tongue (left) to the filleted tongue (right). The fillet
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  straight one. This required handling exit pipes with multiple
                  faces and rewriting the fillet builder to support an arbitrary
                  number of face–scroll intersections. The image shows a
                  successfully filleted volute with a curved exit pipe.
                </p>
              </div>
            </FloatingSection>
          </div>
          ...
          {/* Gallery — shown on screens without the side gallery (< 2xl) */}
