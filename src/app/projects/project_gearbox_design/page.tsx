...
function Project_Gearbox_Design() {
  return (
    <ProjectPageLayout
      title="Gearbox Design for a Spacer Cart"
      fetchUrl="/projects/project_gearbox_design/files.json"
      projectSlug="projects/project_gearbox_design"
    >
      {(items, getItem, handleOpen) => (
        <>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-6">
              <div className="lg:w-1/2 text-justify">
                <p className="mb-4">
                  ...
                  <strong>3-speed forward + 3-speed reverse gearbox</strong> for
                  a spacer cart. The gearbox uses a three-shaft layout (input,
                  counter, output) with dog-clutch engagement and a
                  ball-and-socket shifting mechanism.
                </p>
                <p className="mb-4">
                  <strong>My contributions</strong> covered the full analytical
                  design pipeline: deriving gear radius equations from the shaft
                  geometry, writing a{" "}
                  <strong>brute-force search in Python</strong> to find feasible
                  tooth/module combinations, performing gear safety calculations
                  (Lewis, Buckingham, wear), shaft bending moment analysis with{" "}
                  <strong>Python-generated BMD plots</strong>, bearing
                  selection, and the complete shifting mechanism geometry and
                  CAD design.
                </p>
                <p>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  was selected — it can be cut with standard hobs and the higher
                  pressure angle produces stronger teeth compared to 14½°
                  systems. The minimum number of teeth on any pinion is 18 to
                  avoid interference.
                </p>
                <p>
                  Shaft centre distances are constrained by the gear ratios and
                  the requirement that gear radius{" "}
                  <InlineMath math="R = mT/2" /> must yield a{" "}
                  <strong>positive whole-number tooth count</strong> for a{" "}
                  <strong>standard module</strong>. This creates a combinatorial
                  feasibility problem solved by exhaustive search.
                </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-2 sm:gap-3 items-stretch">
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                ...
                <p>
                  Since <InlineMath math="D = m \times T" /> (diameter = module
                  × teeth), and both module and teeth count must be discrete (
                  <strong>standard module list</strong> and{" "}
                ...
                <ol className="list-decimal list-inside space-y-1 ml-2">
                  ...
                  <li>
                    ...
                    radii of the remaining gears. Try every standard module for
                    each pair and keep only combinations yielding integer teeth.
                  </li>
                  <li>
                    Filter: discard any entry with fractional teeth or count
                    below 18. The search produced 233 candidate rows for reverse
                    gears alone.
                  </li>
                  <li>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  method was applied to reverse gears and the common gear pair.
                  Entries with the largest modules were selected to minimise
                  tooth count and maximise strength.
                </p>
              </div>
            </FloatingSection>
          </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr_1fr] gap-4 my-4">
                <div className="bg-slate-300/50 dark:bg-slate-700/50 rounded-lg p-3 border border-gray-600 dark:border-gray-400">
                  ...
                  <p className="text-xs text-muted-foreground">
                    ...
                    Determines minimum face width <InlineMath math="b_{\min}" />{" "}
                    for each pinion. Velocity factor <InlineMath math="C_v" />{" "}
                    scales the allowable stress for pitch-line speed.
                  </p>
                </div>
                <div className="bg-slate-300/50 dark:bg-slate-700/50 rounded-lg p-3 border border-gray-600 dark:border-gray-400">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Accounts for tooth error and impact. The deformation factor{" "}
                    <InlineMath math="C" /> depends on tooth error in action and
                    gear/pinion moduli of elasticity. Safety:{" "}
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  largest force occurs at the 3rd reverse gear (smallest radius,
                  19.5 mm) at <strong>164 N</strong>.
                </p>
              </div>
            </FloatingSection>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  gear engagement cases. Each scenario considers gear weight and
                  tangential tooth load as point forces along the shaft. These
                  plots were <strong>generated in Python</strong> using the gear
                  positions and loads.
                </p>
              </div>
            </FloatingSection>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  scenarios (reverse + forward) was <strong>9.68 Nm</strong> at
                  3rd reverse engagement. This was used together with the
          ...
          <FloatingSection>
            ...
            <div className="text-justify space-y-3">
              <p>
                The equivalent twisting moment combines bending and torsion with
                shock factors:
              </p>
              <div className="flex justify-center my-3">
              ...
              <p>
                A <strong>10 mm shaft diameter</strong> was selected to provide
                a safety margin and match available bearing sizes. Deep-groove
                ball bearings were chosen based on dynamic load ratings
                calculated from the tangential tooth loads using standard
                bearing life equations (20,000 hours design life).
              </p>
            </div>
          </FloatingSection>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  (left/middle/right), each with forward, neutral, and reverse.
                  A dog-clutch engagement was used: the shifter moves a collar
                  that slides on a splined shaft to mesh with the target gear.
                </p>
              </div>
            </FloatingSection>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-2 sm:gap-3 items-stretch">
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  movements can be made — the internal geometry acts as a shift
                  gate. Cut dimensions were derived from the shifting geometry
                  calculations. The socket is machined separately and welded to
                  the housing top for tighter tolerances.
                </p>
              </div>
            </FloatingSection>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  Location of the shifter in the overall gearbox housing. Levers
                  are held in place through clearance-fit slots built into the
                  middle housing section, allowing the sliding motion needed
                  during gear shifts. The longest lever has two holding sockets
                  for stability while the shorter ones rely on fork interference
                  fits.
                </p>
              </div>
            </FloatingSection>
            ...
            <div className="text-justify space-y-3">
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>
                  ...
                  Buckingham dynamic load, static tooth load, and limiting wear
                  load for every pinion.
                </li>
                <li>
                  <strong>
                    Shaft bending analysis with Python-generated BMD plots
                  </strong>{" "}
                  — free-body diagrams and bending moment curves for all 6 gear
                  engagement cases (3 reverse + 3 forward), leading to
                ...
                <li>
                  ...
                  all shifting angles and dimensions analytically, designed the
                  ball-and-socket mechanism, shift gate, lever system, and
