...
function Project_MeridionalSolver() {
  return (
    <ProjectPageLayout
      title="Meridional Flow Solver"
      fetchUrl="/projects/project_meridional_solver/files.json"
      projectSlug="projects/project_meridional_solver"
    >
        ...
        <>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-6">
              <div className="lg:w-1/2 text-justify">
                <p className="mb-4">
                  ...
                  solve is far too expensive at this stage, so a lighter method
                  is needed.
                </p>
                <p className="mb-4">
                  This project implements a{" "}
                  <strong>quasi-3D streamline-curvature solver</strong> based on
                  the method described by Katsanis (1966) for arbitrary
                  quasi-orthogonal (QO) lines. The algorithm was first
                  prototyped in Python for rapid iteration, then rewritten from
                  scratch in C++ for production integration with the host CAE
                  platform.
                </p>
                <p>
                  The production solver achieves{" "}
                  <strong>sub-second solve times</strong> for dozens of
                  iterations, validated against an existing hub-to-shroud solver
                  and CFD results. It was accepted as a beta feature and merged
          ...
          <FloatingSection>
            ...
            <div className="text-justify space-y-3">
              <p>
                ...
                <em>
                  &ldquo;Use of Arbitrary Quasi-Orthogonals for Calculating Flow
                  Distribution in a Turbomachine&rdquo;
                </em>{" "}
          ...
          >
            <p className="mb-4">
              ...
              ran the iterative solver loop, and plotted results as line charts.
            </p>
            <p className="mb-4">
              ...
              platform. As a workaround, data was exported from the platform for
              a grid of <InlineMath math="(r, z)" /> values and polynomial
            ...
            <p>
              ...
              significant data-transfer overhead. This motivated a full rewrite
              in C++.
            </p>
          </AutoAdjustingSection>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  host-platform objects, QO-line and streamline setup, the main
                  iterative solve loop (flow population, velocity marching,
                  mass-flow balancing, streamline repositioning, convergence
                  checks), and post-processing for blade-loading output.
                </p>
                <p>
                  ...
                  iterative predictor (derived from a Fortran subroutine in the
                  original code) resolved the convergence issues that plagued
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  axis intersects the surface to yield the required angle value;
                  surface iso-curve tangents give the partial derivatives via
                  linear algebra.
                </p>
                <p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-2 sm:gap-3 items-stretch">
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  structs (AOS), field access required two pointer indirections:
                  outer vector → inner vector → struct → field.
                </p>
                <p>
                  ...
                  sequential sweeps over a single variable (the dominant pattern
                  in the solver loop) hit L1/L2 cache almost every time.
                </p>
                <p>
                  ...
                  runtime lookup overhead. Direct data pointers are also exposed
                  for potential SIMD use.
                </p>
                <p>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                ...
                <p>
                  The grid sizes in typical preliminary design (hundreds to low
                  thousands of points) are simply too small for the
                  parallelization to amortize the fixed cost of thread
                  management. The lesson: for small, cache-friendly workloads, a
                  tight sequential loop with good data locality beats
                  multi-threading.
                </p>
                <p>
                  OpenMP remains available as a build option for unusually large
                  meshes, but the default path stays single-threaded.
                </p>
              </div>
            </FloatingSection>
          </div>
          ...
          <AutoAdjustingSection
            ...
            imagePosition="left"
            mediaContent={
              getItem(1) && <ImageDoc image={getItem(1)!} onOpen={handleOpen} />
            }
          >
            <p className="mb-4">
              ...
              boundaries are represented as <strong>Bézier curves</strong> built
              from control points extracted from the host platform&apos;s
              flow-path geometry.
            </p>
            <p className="mb-4">
            ...
            <p>
              QO lines are straight segments from hub to shroud, and the solver
              repositions streamlines by adjusting each streamline&apos;s
              parameter along every QO line until equal mass-flow is carried
              ...
              <div className="text-justify space-y-3 flex-1">
                ...
                <ul className="list-disc list-inside space-y-1 ml-2">
                  <li>
                    ...
                    converged streamlines and QO lines forming the computational
                    grid.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    colour-mapped visualization of any flow variable across the
                    entire meridional plane, using Delaunay triangulation of the
                    grid points.
                  </li>
                </ul>
                <p>
                  ...
                  limits, relaxation, tolerances), choose between interpolation
                  or direct blade-data evaluation, and select the
                  inlet-condition side.
                </p>
              </div>
            </FloatingSection>
          ...
          <FloatingSection>
            ...
            <div className="text-justify space-y-3">
              <p>
                ...
                implementation are proprietary, but the high-level architecture
                can be summarized:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-2">
                <li>
                  ...
                  blade-loading, and post-processing. Exposes a clean public API
                  for the task-window layer.
                </li>
                <li>
                  <strong>Data model</strong> — the template metaprogramming SOA
                  container holding ~50 flow variables with compile-time typed
                  access. Also defines all data extraction enums and structures.
                </li>
                <li>
                  <strong>Curve layer</strong> — OCC-based hierarchy for
                  Bézier/B-spline flow-path curves, streamlines, QO lines, and a
                ...
                <li>
                  <strong>Task window</strong> — Qt integration layer connecting
                  the solver to the platform&apos;s workflow, handling
                  stage/segment selection, inlet-condition import, and all three
                  plot panels.
                </li>
              </ul>
            </div>
