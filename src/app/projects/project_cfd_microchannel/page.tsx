...
function Project_CFD_Microchannel() {
  return (
    <ProjectPageLayout
      title="CFD Study on Micro Channel Heat Sink"
      fetchUrl="/projects/project_cfd_microchannel/files.json"
      projectSlug="projects/project_cfd_microchannel"
    >
        ...
        <>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-6">
              <div className="lg:w-1/2 text-justify">
                <p className="mb-4">
                  ...
                  <strong>circular ribs</strong> on the channel walls. The ribs
                  disrupt the thermal boundary layer to enhance convective heat
                  transfer — a critical need as chip power densities push past
                  500 W in modern AI accelerators and GPUs.
                </p>
                <p className="mb-4">
                  The study simulates{" "}
                  ...
                  Nusselt number and friction factor. The geometry was modelled
                  in SolidWorks due to ANSYS SpaceClaim&apos;s inability to
                  handle the micro-scale rib dimensions (25 µm radius).
                </p>
                <p>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  <strong>single periodic element</strong> of a heatsink with 50
                  parallel channels. The channel has a rectangular cross section
                  (W = 0.1 mm, H = 0.2 mm) and a length of 20 mm. The solid
                  domain (silicon) surrounds the channel on three sides while
                  the top is modelled as an adiabatic wall.
                </p>
                <p>
                  ...
                  heat flux of{" "}
                  <InlineMath math="1 \times 10^6 \, \text{W/m}^2" /> is applied
                  to the bottom face.
                </p>
              </div>
            </FloatingSection>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  the vertical channel walls with a pitch of 0.4 mm. The sector
                  angle (60° for this study) controls how far the rib extends
                  into the flow. These features disrupt the developing boundary
                  layer and introduce local velocity increases that enhance
          ...
          <FloatingSection className="max-w-[60%] mx-auto">
            ...
            <div className="text-justify space-y-3">
              <p>
                ...
                conservative target of <InlineMath math="y^+ = 0.8" /> was used
                to derive the first boundary layer cell height analytically.
              </p>
              ...
              <p>
                ...
                simulations. A separate boundary layer on the solid side with a
                first height of 1 µm ensures adequate aspect ratio across the
                interface.
              </p>
            </div>
          </FloatingSection>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-2 sm:gap-3 items-stretch">
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  Surface mesh on the solid-fluid boundary near a circular rib.
                  The extremely small boundary layer cells around the rib
                  curvature led to challenging mesh quality metrics — minimum
                  orthogonal quality of 0.25 and maximum skewness of 0.75, both
                  near the acceptable limits.
                </p>
              </div>
            </FloatingSection>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-2 sm:gap-3 items-stretch">
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  Eight meshes from 908K to 2.3M cells were tested at Re = 100.
                  Both the average Nusselt number and friction factor converge
                  as the cell count increases, with successive variations
                  dropping below 0.2%. The final 2.3M-cell mesh was selected for
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  monitored — the inlet-outlet mass flow difference converges to
                  near zero, confirming global conservation.
                </p>
              </div>
            </FloatingSection>
          </div>
            ...
            <div className="text-justify space-y-3">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-4 my-4">
                <div className="bg-slate-300/50 dark:bg-slate-700/50 rounded-lg p-3 border border-gray-600 dark:border-gray-400">
                  <h3 className="font-semibold mb-2">Average Nusselt Number</h3>
                ...
                <div className="bg-slate-300/50 dark:bg-slate-700/50 rounded-lg p-3 border border-gray-600 dark:border-gray-400">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Calculated from the pressure drop across the channel. Outlet
                    pressure is the zero-gauge BC; inlet pressure is extracted
                    as the area-weighted average.
                  </p>
                </div>
              </div>
            </div>
          ...
          <FloatingSection>
            <div className="text-justify space-y-3 mb-4">
              <p>
                ...
                . Each subplot shares a unified colour bar so that the variation
                across Reynolds numbers can be compared directly — something
                that cannot be achieved natively in ANSYS, where each plot uses
                its own auto-scaled colour range.
              </p>
            </div>
          </FloatingSection>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  temperature differential. At low Re, the fluid reaches higher
                  temperatures but the solid also runs hotter; at high Re,
                  efficient heat extraction keeps both domains cooler.
                </p>
              </div>
            </FloatingSection>
          </div>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  (solid-fluid boundary). The distribution mirrors the mid plane
                  trends but reveals the direct contact thermal profile where
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  velocity coinciding with rib locations. As Re increases, these
                  regions elongate and eventually merge around Re ≈ 600. The
                  velocity structure transitions from isolated disturbances to a
                  developed core flow separated from the boundary layers.
                </p>
              </div>
            </FloatingSection>
          </div>
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  divergence at higher Re. The discrepancy is attributed to the
                  boundary layer height being derived purely from flow dynamics
                  (y⁺ calculation) without considering the thermal boundary
                  layer thickness — leading to under-resolved thermal gradients
            ...
            <FloatingSection className="flex flex-col">
              ...
              <div className="text-justify space-y-3 flex-1">
                <p>
                  ...
                  difference rather than a physics modelling error — consistent
                  with the grid independence study being performed only at Re =
                  100.
                </p>
              </div>
            </FloatingSection>
            ...
            <div className="text-justify space-y-3">
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>
                  ...
                  rise and heatsink steady-state temperature, but at the cost of{" "}
                  <strong>
                ...
                <li>
                  ...
                  particularly the elliptical high-velocity regions observed in
                  the velocity contours.
                </li>
                <li>
                  A more accurate approach for future work would consider the{" "}
                  <strong>thermal boundary layer</strong> when sizing the first
                  cell height, and use surface heat flux integration rather than
                  outlet temperature for Nusselt number calculation.
                </li>
              </ul>
            </div>
          </FloatingSection>
