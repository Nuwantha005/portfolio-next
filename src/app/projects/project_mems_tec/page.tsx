...
function Project_MEMS_TEC() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      fetch("/projects/project_mems_tec/files.json")
        .then((res) => res.json())
        .then((data) => {
          setItems(data);
        })
  ...
  return (
    <div>
      <div className="relative flex h-screen w-screen flex-col items-center justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl">
        <ProjectTitleBar title="MEMS Radial Thermoelectric Cooler" />
        <main className="relative z-10 w-full overflow-y-auto overflow-x-hidden h-full">
          <div className="relative z-10 p-2 sm:p-3 md:p-4 space-y-2 sm:space-y-3 text-sm sm:text-base">
              ...
              <div className="flex flex-col lg:flex-row items-center gap-6">
                <div className="lg:w-1/2 text-justify">
                  <p className="mb-4">
                    ...
                    of the critical thermal challenges in modern chip design.
                    This project designed a{" "}
                    <strong>radial thermoelectric cooler (TEC)</strong> at MEMS
                    scale to actively pump heat from localized hotspots on a
                    chip surface, using the <strong>Peltier effect</strong> to
                    move thermal energy radially outward from a central heat
                    source to a surrounding micro-channel heat sink (MCHS).
                  </p>
                  <p className="mb-4">
                    ...
                    geometry, and coupled multiphysics COMSOL simulations
                    validate the design through a{" "}
            ...
            >
              <p className="mb-4">
                As transistor densities increase and chip architectures move to
                3D stacking, localized thermal hotspots become the dominant
                failure and throttling mechanism. Conventional passive heat
                sinks cannot address temperature non-uniformity — the hottest
                region dictates the whole chip&apos;s clock speed even if the
                average temperature is acceptable.
              </p>
              <p>
                <strong>Thermoelectric coolers</strong> offer active,
                solid-state heat pumping with no moving parts. The Peltier
                effect drives heat from the cold junction (chip surface) to the
                hot junction (heat sink), and at MEMS scale these devices can be
                fabricated directly on-chip. This project explores a{" "}
                <strong>radial</strong> TEC geometry that exploits the natural
                circular symmetry of a hotspot.
              </p>
            </AutoAdjustingSection>
              ...
              <FloatingSection className="flex flex-col">
                ...
                <div className="text-justify space-y-3 flex-1">
                  <p>
                    ...
                    central high-heat-flux zone (e.g., cache) is cooled by the
                    TEC while the surrounding lower-flux zone (e.g., logic) is
                    handled by the MCHS ring. This targeted cooling reduces peak
            ...
            >
              ...
              <p>
                The radial geometry naturally provides increasing
                cross-sectional area toward the periphery, which helps
                accommodate the growing heat flux as Peltier effect adds Joule
                dissipation at each successive stage.
              </p>
            </AutoAdjustingSection>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr_1fr] gap-2 sm:gap-3 items-stretch">
              <FloatingSection className="flex flex-col">
                ...
                <div className="text-justify space-y-3 flex-1">
                  <p>
                    An isometric view of one TEC wedge showing the
                    interconnectors (copper), thermoelectric legs (Bi₂Te₃),
                    radial insulators (AlN-loaded epoxy), and azimuthal
                    insulators (SiO₂). The wedge angle is 30° for a 12-wedge
                    assembly.
                  </p>
                </div>
              </FloatingSection>
              ...
              <FloatingSection className="flex flex-col">
                ...
                <div className="text-justify space-y-3 flex-1">
                  <p>
                    ...
                    p-type Bi₂Te₃ leg pair connected by a copper interconnector
                    at the hot side and an outerconnect at the cold side. The
                    legs have a variable cross-section that increases radially.
                  </p>
                </div>
              </FloatingSection>
            </div>
              ...
              <FloatingSection className="flex flex-col">
                ...
                <div className="text-justify space-y-3 flex-1">
                  <p>
                    ...
                    central cylinder — is modelled as a resistance element.
                    Energy balance at each node yields a{" "}
                  ...
                  <p>
                    ...
                    unknown node temperatures, <InlineMath math="\mathbf{A}" />{" "}
                    is a block matrix of thermal conductances, and{" "}
                  ...
                  <p>
                    ...
                    vertical coupling between layers). This yields
                    sub-millisecond solves in MATLAB, enabling rapid parameter
                    sweeps that would be infeasible with full FEA.
                  </p>
                </div>
              </FloatingSection>
              ...
              <FloatingSection className="flex flex-col">
                ...
                <div className="text-justify space-y-3 flex-1">
                  ...
                  <p>
                    ...
                    hot-junction temperatures, <InlineMath math="K" /> the
                    thermal conductance, and <InlineMath math="R" /> the
            ...
            <FloatingSection>
              ...
              <div className="text-justify space-y-3">
                <p>
                  The design involves approximately{" "}
                  <strong>20 parameters</strong> organized into three
                  categories:
                </p>
                ...
                <p>
                  ...
                  impact on peak chip temperature, while the number of stages
                  and wedges are the primary discrete variables that define the
                  device topology.
                </p>
              </div>
            </FloatingSection>
              ...
              <FloatingSection className="flex flex-col">
                ...
                <div className="text-justify space-y-3 flex-1">
                  <p>
                    ...
                    MATLAB implementation evaluates the full thermal field
                    across chip and TEC layers for any combination of design
                    parameters.
                  </p>
                  <p>
                    Each objective function call simply assembles and solves the{" "}
                    <InlineMath math="\mathbf{A} \cdot \mathbf{T} = \mathbf{B}" />{" "}
                    system, extracts the maximum chip temperature, and returns
                    it to the optimizer.
                  </p>
                </div>
              </FloatingSection>
              ...
              <FloatingSection className="flex flex-col">
                ...
                <div className="text-justify space-y-3 flex-1">
                  <p>
                    ...
                    maximum chip temperature is recorded. The matrix plot
                    reveals the feasible design space and identifies the optimal
                    region around <InlineMath math="N = 7, M = 16" />.
                  </p>
                  <p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-2 sm:gap-3 items-stretch">
              <FloatingSection className="flex flex-col">
                ...
                <div className="text-justify space-y-3 flex-1">
                  <p>
                    With discrete parameters fixed, a multi-objective
                    optimization minimizes two conflicting objectives:{" "}
              ...
              <FloatingSection className="flex flex-col">
                ...
                <div className="text-justify space-y-3 flex-1">
                  ...
                  <p>
                    The complete optimal parameter set includes: 7 TEC stages,
                    16 radial wedges, operating current of 0.3 A, TE leg length
                    ratio <InlineMath math="f_L = 0.65" />, insulator thickness
                    of 15 µm, and an inner radius of 1.5 mm for the central
                    cylinder.
                  </p>
                </div>
              </FloatingSection>
              ...
              <div className="text-justify space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-4">
                  <div className="bg-blue-500/10 dark:bg-blue-400/10 rounded-lg p-3 border border-blue-500/30">
                    ...
                    <p className="text-sm">
                      Parametric CAD model of the radial TEC. Geometry
                      dimensions are driven by the optimization variables —
                      changing a parameter in MATLAB updates the SolidWorks
                      model automatically.
                    </p>
                  </div>
                  <div className="bg-green-500/10 dark:bg-green-400/10 rounded-lg p-3 border border-green-500/30">
                    ...
                    <p className="text-sm">
                      COMSOL imports the SolidWorks geometry via LiveLink,
                      applies physics (thermoelectric + fluid flow +
                      structural), meshes, and solves. The coupled multiphysics
                      includes Peltier/Thomson effects, conjugate heat transfer,
                      and thermal stress.
                    </p>
                  </div>
                  <div className="bg-purple-500/10 dark:bg-purple-400/10 rounded-lg p-3 border border-purple-500/30">
                    ...
                    <p className="text-sm">
                      ...
                      triggers geometry rebuild, runs COMSOL solver, and
                      extracts results. This enables parametric sweeps and
                      automated validation against the CTM predictions.
                    </p>
                  </div>
                </div>
                <p>
                  ...
                  <strong>Solid Mechanics</strong>. Multiphysics couplings
                  handle the thermoelectric effect, electromagnetic heating,
                  non-isothermal flow, and thermal expansion. A segregated
                  solver converges in 20–50 iterations.
                </p>
              </div>
            </FloatingSection>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-2 sm:gap-3 items-stretch">
              <FloatingSection className="flex flex-col">
                ...
                <div className="text-justify space-y-3 flex-1">
                  <p>
                    A parametric sweep of operating current identifies the
                    optimal value at <strong>0.3 A</strong>. Below this, Peltier
                    cooling is insufficient; above it, Joule heating dominates
                    and the device heats the chip rather than cooling it. The
                    outward heat flux at the optimum is 0.49 W per wedge.
                  </p>
                </div>
              </FloatingSection>
              ...
              <FloatingSection className="flex flex-col">
                ...
                <div className="text-justify space-y-3 flex-1">
                  <p>
                    ...
                    the radial temperature gradient from the hot central region
                    to the cooler outer periphery. The simulation confirms the
                    design intent — heat is actively pumped outward through the
                    TEC stages, creating a smooth temperature drop across the
                    device.
                  </p>
                </div>
              </FloatingSection>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-2 sm:gap-3 items-stretch">
              <FloatingSection className="flex flex-col">
                ...
                <div className="text-justify space-y-3 flex-1">
                  <p>
                    ...
                    m/s. Conjugate heat transfer between the solid walls and
                    water flow provides the final heat rejection path.
                  </p>
                </div>
              </FloatingSection>
              ...
              <FloatingSection className="flex flex-col">
                ...
                <div className="text-justify space-y-3 flex-1">
                  <p>
                    Temperature distribution in the region near the micro
                    channels shows effective heat removal by the liquid coolant.
                    The water temperature rises from 25 °C at the inlet to
                    approximately 28 °C at the outlet, confirming adequate
                    thermal capacity for the rejected heat load.
                  </p>
                </div>
              </FloatingSection>
            </div>
            ...
            >
              <p className="mb-4">
                A thermal-structural analysis evaluates Von Mises stresses
                arising from thermal expansion mismatch between dissimilar
                materials (Bi₂Te₃, Cu, AlN, SiO₂, SU-8). The maximum stress is
                on the order of 10⁸ Pa, which remains within safe limits for the
                materials involved.
              </p>
              <p>
            ...
            >
              <p className="mb-4">
                A complete set of <strong>10 photomasks</strong> was designed
                for the MEMS fabrication process. The fabrication uses standard
              ...
              <ul className="list-disc list-inside space-y-1 mb-4">
                ...
                <li>
                  <strong>SU-8 negative photoresist</strong> — micro-channel
                  heat sink structure (1:100 aspect ratio)
                </li>
                <li>
